package com.lanshifu.baselibrary_master.widget;
...
public class ResideLayout extends ViewGroup {
     ...
     * 是否可左滑
     */
    private boolean mCanLeftSlide1 = true;

    /**
     * 是否可左滑（用两个标志位是在判断侧边栏打开，viewpager不在0的时候）
     */
//    private boolean mCanLeftSlide2 = false;
...
//            mCanLeftSlide2=false;
    ...
    public void setCanLeftSlide(boolean canLeftSlide) {
        mCanLeftSlide1 = canLeftSlide;
    }
