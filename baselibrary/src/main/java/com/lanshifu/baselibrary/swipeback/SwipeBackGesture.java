...
public class SwipeBackGesture {
     ...
     * 滑动进度条
     */
    private SwipeBackProgress mProgress;
    /**
     * 进度条宽度
     */
    ...
    public SwipeBackGesture(Activity activity) {
        ...
        mScreenHeigh = Math.max(width, height);
        maxMove = (int) (mScreenWidth * 0.06);
        moveScaling = 0.2f;
        progressWidth = mScreenWidth / 9; //进度条大小是 屏幕宽度 1/9
    }
    ...
    private void initProgress() {
        mProgress = new SwipeBackProgress(mActivity);
        ...
        mProgress.setTranslationY(mScreenHeigh /2);
